...
1. [Create](https://github.com/join?source=header-home) a Github account, don't forget to verify your email before loging in. I suppose that you signed up with name `nguyenduycuong`.
2. Login to your Github account.
3. Create a new repository by clicking **New** on the right side of *Repositories* section and naming your repo with `<your-account>.github.io`. For example, my Github account is "*nguyenduycuong*", so I name this repo "*nguyenduycuong.github.io*". We need to name the repo like this because your website will have an address like **https://\<your-account\>.github.io**.
4. Basically, you now have a place where you can put your website, you can choose either a built-in theme from Github or an external theme.
	- If you wanna apply **[NoteTheme](https://github.com/nguyenduycuong/NoteTheme)** (or [other external theme](http://jekyllthemes.org/)), please step to next section ([How to apply NoteTheme](#how-to-apply-notetheme)) and ignore following steps in this section.
...
4. From this step, you will apply a theme [downloaded from the internet](http://jekyllthemes.org) for your Github page. In this case, you will apply **[NoteTheme](https://github.com/nguyenduycuong/NoteTheme)**.
5. Download [NoteTheme](https://github.com/nguyenduycuong/NoteTheme) to your local computer (a file .zip)
